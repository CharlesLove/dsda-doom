...
setup_menu_t stat_settings2[] =
{
  ...
  {"ONLY DISPLAY CROSSHAIR ON TARGET"        ,S_YESNO    ,m_null,ADVHUD_X,SB_Y+15*8, {"hudadd_crosshair_show_target"}},
...
setup_menu_t gen_settings3[] = { // General Settings screen2
  ...
  {"Force Disable Playback Bob",  S_YESNO, m_null, G_X, G_Y+ 5*8, {"demo_forcedisablebob"}},
  ...
  {"Enable Mouselook",            S_YESNO, m_dsda, G_X, G_Y+15*8, {"movement_mouselook"}, 0},
  {"No Vertical Mouse",           S_YESNO, m_dsda, G_X, G_Y+16*8, {"movement_mousenovert"}},
  {"Invert Mouse",                S_YESNO, m_null, G_X, G_Y+17*8, {"movement_mouseinvert"}, 0, M_ChangeMouseInvert},
  {"Max View Pitch",              S_NUM,   m_null, G_X, G_Y+18*8, {"movement_maxviewpitch"}, 0, M_ChangeMaxViewPitch},
...
setup_menu_t dsda_gen_settings[] = {
  ...
  { "Hide Totals", S_YESNO, m_dsda, G_X, G_Y + 7 * 8, { "dsda_hide_totals" } },
  { "Wipe At Full Speed", S_YESNO, m_null, G_X, G_Y + 8 * 8, { "dsda_wipe_at_full_speed" } },
  { "Show Demo Attempts", S_YESNO, m_null, G_X, G_Y + 9 * 8, { "dsda_show_demo_attempts" } },
  { "Fine Sensitivity", S_NUM, m_null, G_X, G_Y + 10 * 8, { "dsda_fine_sensitivity" } },
  { "Hide Status Bar Horns", S_YESNO, m_null, G_X, G_Y + 11 * 8, { "dsda_hide_horns" } },
  { "Organize My Save Files", S_YESNO, m_null, G_X, G_Y + 12 * 8, { "dsda_organized_saves" } },
  { "Show Command Display (TAS)", S_YESNO, m_dsda, G_X, G_Y + 13 * 8, { "dsda_command_display" } },
  { "Command History", S_NUM, m_null, G_X, G_Y + 14 * 8, { "dsda_command_history_size" } },
  { "Hide Empty Commands", S_YESNO, m_null, G_X, G_Y + 15 * 8, { "dsda_hide_empty_commands" } },
  { "Show Coordinate Display (TAS)", S_YESNO, m_dsda, G_X, G_Y + 16 * 8, { "dsda_coordinate_display" } },
  { "Skip Quit Prompt", S_YESNO, m_null, G_X, G_Y + 17 * 8, { "dsda_skip_quit_prompt" } },
  { "Show Split Data", S_YESNO, m_null, G_X, G_Y + 18 * 8, { "dsda_show_split_data" } },
  { "Text File Author", S_NAME, m_null, G_X, G_Y + 19 * 8, { "dsda_player_name" } },
