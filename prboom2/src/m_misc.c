...
default_t defaults[] =
{
  ...
  {"demo_smoothturnsfactor", {&demo_smoothturnsfactor},  {6},1,SMOOTH_PLAYING_MAXFACTOR,
   def_int,ss_stat},
  {"demo_forcedisablebob", {&demo_forcedisablebob}, {0},0,1,def_bool,ss_stat},
  ...
  /* 640x400 scaled to 640x480 default resolution */
  {"screen_resolution",{NULL, &screen_resolution},{0,"640x400"},UL,UL,def_str,ss_none},
  ...
  {"uncapped_framerate", {&movement_smooth_default},  {1},0,1,
   def_bool,ss_stat},
  {"dsda_maxframes", {&dsda_maxframes}, {500}, 35, 500, def_int, ss_stat},
  ...
  {"hudadd_crosshair_lock_target", {&hudadd_crosshair_lock_target},  {0},0,1,
   def_bool,ss_stat},
   {"hudadd_crosshair_show_target", {&hudadd_crosshair_show_target},  {0},0,1,
   def_bool,ss_stat},
  ...
  { "dsda_hide_totals", { (int *) &dsda_setting[dsda_hide_totals] }, { 0 }, 0, 1, def_bool, ss_stat },
  ...
  {"render_stretch_hud", {&render_stretch_hud_default},{1},0,patch_stretch_max - 1,
  def_int,ss_stat},
