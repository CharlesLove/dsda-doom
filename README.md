...
- V-sync is now only enabled for software exclusive fullscreen where tearing is an issue. A cap of 500fps has been put in place globally when v-sync is not active.
